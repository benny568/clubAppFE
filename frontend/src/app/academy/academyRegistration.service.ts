...
export class AcademyRegistrationService {
	...
	regData = [
	           { id: 0, name: 'First name', value: '', required: true, display: true, type: 'input',
	        	 placeholder: "Childs first name"
	           },
	           { id: 1, name: 'Last name', value: '', required: true, display: true, type: 'input',
	        	 placeholder: "Childs last name"
	        	},
	           { id: 2, name: 'email', value: 'email', required: true, display: true, type: 'input',
		         placeholder: "Parent's email" },
	           { id: 3, name: 'Date of Birth', value: '', required: true, display: true, type: 'input',
			     placeholder: "Childs birth date" },
	           { id: 4, name: 'First contact number', value: '', required: true, display: true, type: 'input',
				 placeholder: "First Parent's number" },
	           { id: 5, name: 'Second contact number', value: '', required: true, display: true, type: 'input',
				 placeholder: "Second Parent's number" },
	           { id: 6, name: 'Allergy information', value: '', required: true, display: true, type: 'input',
				 placeholder: "Details on any allergies" },
	           { id: 7, name: 'Asthma', value: '', required: true, display: true, type: 'input',
				 placeholder: "Has the child asthma?" },
	           { id: 8, name: 'Diabetes', value: '', required: true, display: true, type: 'input',
				 placeholder: "Has the child diabetes?" },
	           { id: 9, name: 'Medication', value: '', required: true, display: true, type: 'input',
				 placeholder: "Is the child on any medication?" },
	           { id: 10, name: 'Notes', value: '', required: false, display: true, type: 'input',
				 placeholder: 'Additional notes' },
	           { id: 11, name: 'Registration Date', value: '', required: true, display: false, type: 'input',
	        	 placeholder: "Date of registration" },
	           { id: 12, name: 'Mother\'s Name', value: '', required: true, display: true, type: 'input',
		         placeholder: "Mother's name" },
	           { id: 13, name: 'Father\'s name', value: '', required: true, display: true, type: 'input',
