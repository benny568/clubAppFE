...
export class MemberService {
    ...
    public loadCurrentTeamMembersByTeamId( team: number, callback )
    {
     ...
     * Return:
     **********************************************************/
    private applyMemberDelFromTeam( team, memberId )
	{
        this.lg$.log("-> applyMemberDelFromTeam("+team+","+memberId+")");

		var index:number = this.findMemberIndex( team, memberId );
    ...
    applyMemberAdd( members, member )
	{
		...
		var index = this.findMemberIndex( this.msTeamMembers[member.team], member );
     ...
     **********************************************************/
    private findMemberIndex( members, memberId )
	{
