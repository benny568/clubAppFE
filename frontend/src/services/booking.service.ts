...
export class BookingService {
	...
	storeBookingDetails()
	{
		...
		data.arrivalDate = this.convertDateToString(this.arrivalDate);
		data.departureDate = this.convertDateToString(this.departureDate);
...
//	            );
	...
	public traceBookingDetails()
	{
		this.lg$.trace("logBookingDetails():");
		this.lg$.trace("================================");
		this.lg$.trace("  firstname: " + this.firstname);
		this.lg$.trace("  surname:  " + this.surname);
		this.lg$.trace("  email:  " + this.email);
		this.lg$.trace("  phone:  " + this.phone);
		this.lg$.trace("  country:  " + this.country);
        this.lg$.trace("  Arrival Date: " + this.arrivalDate);
        this.lg$.trace("  Departure Date: " + this.departureDate);
        this.lg$.trace("  Number of Nights: " + this.numberOfNights);
        this.lg$.trace("  Number of People: " + this.numberOfPeople);
        this.lg$.trace("  Parking: " + this.parking);
        this.lg$.trace("  Car Reg: " + this.vehicalReg);
		this.lg$.trace("  totalCharge:  " + this.totalCharge);
		this.lg$.trace("  deposit:  " + this.deposit);
		this.lg$.trace("  tandc:  " + this.tandc);
	}
